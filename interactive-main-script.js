...
// Function to sort nodes by tags
...
// Function to assign colors to links based on source and target tags
...
d3.json("data.json").then((graph) => {
  ...
  function handleMouseOut() {
    // Reset all nodes, links, and labels to default
  ...
  function handleClick(event, d) {
    // Display the info div with the node ID
    infoDiv
...
// Hide the info div when clicking outside of it
